  ...
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full px-4 text-center">
        ...
        <p className="text-neutral-900 font-semibold text-lg mb-2">Start a conversation</p>
        <p className="text-neutral-500 text-sm max-w-sm">Describe what you want to build and I'll generate it for you</p>
      </div>
    );
  }
